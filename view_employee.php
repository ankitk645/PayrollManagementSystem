              ...
              <form class="form-horizontal" action="update_employee.php" method="post" name="form">
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="emp_designation" class="form-control" value="<?php echo $row['emp_designation'];?>" required="required">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-5 control-label">Basic Pay  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="basic_pay" id="basic_pay" onblur="cal_hra()" class="form-control" value="<?php echo $row['basic_pay'];?>" required="required">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-5 control-label">HRA  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="hra" id="hra" class="form-control" value="<?php echo $row['hra'];?>" required="required" readonly>
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-5 control-label">Profession Tax  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="profession_tax" class="form-control" value="<?php echo $row['profession_tax'];?>" required="required">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-5 control-label">Bank Name  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="bank_name" class="form-control" value="<?php echo $row['bank_name'];?>" required="required">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-5 control-label">Account No.  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="acc_no" class="form-control" value="<?php echo $row['acc_no'];?>" required="required">
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-5 control-label">IFSC Code  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="ifsc_code" class="form-control" value="<?php echo $row['ifsc_code'];?>" required="required">
                    </div>
                  </div>
				  <div class="form-group">
