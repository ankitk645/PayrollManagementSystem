...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="masthead">
        <h3>
          <b><a href="index.php">Miraj Infotech Pvt. Ltd. </a></b>
          ...
          <div class="well bs-component">
            <form class="form-horizontal">
              <fieldset>
				...
				<a href="previous_records.php"> View Previous Records</a>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <a class="btn btn-primary" href="send_payroll.php?emp_id=<?php echo $row["emp_id"]; ?>">Generate Payroll</a>
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="#" name="form" method="post">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="emp_designation" class="form-control" placeholder="Designation" required="required">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-4 control-label">Basic Pay</label>
                  <div class="col-sm-8">
                    <input type="number" name="basic_pay" id="basic_pay" onblur="cal_hra()" class="form-control" placeholder="Basic Pay" required="required">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-4 control-label">HRA</label>
                  <div class="col-sm-8">
                    <input type="number" name="hra" id="hra" class="form-control" placeholder="HRA" required="required">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-4 control-label">Profession Tax</label>
                  <div class="col-sm-8">
                    <input type="number" name="profession_tax" class="form-control" placeholder="Profession Tax" required="required">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-4 control-label">Bank Name</label>
                  <div class="col-sm-8">
                    <input type="text" name="bank_name" class="form-control" placeholder="Bank Name" required="required">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-4 control-label">Account Number</label>
                  <div class="col-sm-8">
                    <input type="number" name="acc_no" class="form-control" placeholder="Account Number" required="required">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-4 control-label">IFSC Code</label>
                  <div class="col-sm-8">
                    <input type="text" name="ifsc_code" class="form-control" placeholder="IFSC Code" required="required">
                  </div>
                </div>
				<div class="form-group">
				...
				<script>
						function cal_hra()
						{
							var basic_pay = parseInt(document.getElementById("basic_pay").value);
							var hra = (basic_pay * 40)/100;
