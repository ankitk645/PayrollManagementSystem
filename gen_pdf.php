...
{
    // Logo
    $this->Image('miraj.jpg',90,5,20);
    // Arial bold 15
    $this->SetFont('Arial','B',18);
    // Move to the right
    $this->Cell(55);
    // Title
    $this->Cell(30,50,'Miraj Infotech Pvt. Ltd.','C');
	$this->Ln(20);
	$this->SetFont('Arial','',9);
	$this->Cell(40);
	$this->Cell(10,20,'Address line 1, Address line 2, Danapur, Patna, Bihar, PIN: 801503','C');
}
...
function Footer()
{
	...
	if(isset($_POST['submit']))
	{
		...
		$pdf->SetFont('Times','B',9);
			$pdf->Cell(120,5,' ',0,0);
			$pdf->Cell(0,5,'Phone No. : +91 0099009988',0,1);
			$pdf->Cell(120,5,' ',0,0);
			$pdf->Cell(0,5,'Email ID : finance@miraj-infotech.com',0,1);
			$pdf->Cell(120,5,' ',0,0);
			$pdf->Cell(0,5,'Website : www.miraj-infotech.com',0,1);
